...
library(MyStat302Package)
```
In this package, it includes six functions, which are my_pow, f_to_c, my_t.test, my_lm, my_knn_cv, and my_rf_cv. Below contains four tutorial for my_t.test, my_lm, my_knn_cv, and my_rf_cv respectively.
